            ...
            <div class="album-btns-container">
              ...
              <div class="btns-container">
                <button class="fav-btn" title="añadir a favoritos">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 150 150">
                    <path
                ...
                <lable class="track-duration" title="duración de la canción">{{ trackDuration(item.duration_ms) }}</lable>
